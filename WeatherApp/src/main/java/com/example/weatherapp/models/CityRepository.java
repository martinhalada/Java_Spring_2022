...
public interface CityRepository extends JpaRepository<City, String> {
    ...
    List<City> findCitiesByStateCode(String name);
...
public class CityRepository{
    ...
    public List<City> findCitiesByStateCode(String stateCode){
        ...
        /** return (List<City>)jdbcTemplate.queryForObject("SELECT name, region, state FROM City WHERE region = ?",
                new Object[]{stateCode},
    ...
    public City findCityByName(String name){
        return (City)jdbcTemplate.queryForObject("SELECT name, region, state FROM City WHERE name = ?",
                new Object[]{name},
                new BeanPropertyRowMapper(City.class));
    }
     */
